...
The :doc:`previous tutorial <../Introducing-Turtlesim/index>` shows you how to install the ``turtlesim`` package used here.
...
The turtlesim window will open, as you saw in the :doc:`previous tutorial <../Introducing-Turtlesim/index>`.
...
Now that you understand nodes in ROS 2, you can move on to the :doc:`topics tutorial <../Understanding-ROS2-Topics/index>`.
