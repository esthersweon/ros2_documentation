...
You will need :doc:`rqt_console and turtlesim </Tutorials/Beginner-CLI-Tools/Introducing-Turtlesim/index>` installed.
...
In a new terminal, enter the ``ros2 topic pub`` command (discussed in detail in the :doc:`topics tutorial </Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Topics/index>`) below:
...
The next tutorial will teach you about starting multiple nodes at once with :doc:`ROS 2 Launch </Tutorials/Beginner-CLI-Tools/CLI-Intro/index>`.
