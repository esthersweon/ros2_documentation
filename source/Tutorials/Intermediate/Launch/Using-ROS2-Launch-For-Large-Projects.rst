...
This tutorial uses the :doc:`turtlesim </Tutorials/Beginner-CLI-Tools/Introducing-Turtlesim/index>` and :doc:`turtle_tf2_py <../Tf2/Introduction-To-Tf2>` packages.
...
To learn how to do that, refer to the :doc:`Understand parameters </Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Parameters/index>` tutorial.
...
To learn more about using parameters and using YAML files, take a look at the :doc:`Understand parameters </Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Parameters/index>` tutorial.
