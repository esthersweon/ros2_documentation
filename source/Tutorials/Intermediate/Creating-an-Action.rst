...
You learned about actions previously in the :doc:`../Beginner-CLI-Tools/Understanding-ROS2-Actions/index` tutorial.
...
Set up a :doc:`workspace </Tutorials/Beginner-Client-Libraries/Creating-A-Workspace/index>` and create a package named ``action_tutorials_interfaces``:
