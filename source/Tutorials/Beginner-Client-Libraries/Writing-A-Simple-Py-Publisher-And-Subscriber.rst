...
In this tutorial, you will create :doc:`nodes </Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Nodes/index>` that pass information in the form of string messages to each other over a :doc:`topic </Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Topics/index>`.
...
Recall from the :doc:`topics tutorial </Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Topics/index>` that the topic name and message type used by the publisher and subscriber must match to allow them to communicate.
