...
When :doc:`nodes </Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Nodes/index>` communicate using :doc:`services </Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Services/index>`, the node that sends a request for data is called the client node, and the one that responds to the request is the service node.
